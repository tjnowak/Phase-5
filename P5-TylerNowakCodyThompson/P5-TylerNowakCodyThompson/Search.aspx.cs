...
namespace P5_TylerNowakCodyThompson
{
    public partial class Search : System.Web.UI.Page
    {
        ...
        protected void PropertyDropDown_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "TORNADO TYPE":
                    Value1QuestionLabel.Text = "Please enter the tornado type (EF0 through EF5) you" +
                                               " are searching for.";
                    break;
                case "STATE":
                    Value1QuestionLabel.Text = "Please enter the full name of the state you are" +
                                               " searching for.";
                    break;
                case "COUNTY":
                    Value1QuestionLabel.Text = "Please enter the full county name you are searching for.";
                    break;
                case "START AZIMUTH":
                    Value1QuestionLabel.Text = "Please enter the starting azimuth (Compass direction," +
                                               " Ex: SW) you are searching for. ";
                    break;
                case "START LOCATION":
                    Value1QuestionLabel.Text = "Please enter the full start location name (nearest city)" +
                                               " you are searching for.";
                    break;
                case "END AZIMUTH":
                    Value1QuestionLabel.Text = "Please enter the ending azimuth (Compass direction, Ex: SW)" +
                                               " you are searching for .";
                    break;
                case "END LOCATION":
                    Value1QuestionLabel.Text = "Please enter the full end location name (nearest city)" +
                                               " you are searching for.";
                    break;
                case "TIME ZONE":
                    Value1QuestionLabel.Text = "Please enter the time zone (Ex: est) you are searching for.";
                    break;
                case "INJURIES":
                    Value1QuestionLabel.Text = "Please enter the lower bound (integer) on the range of the" +
                ...
                case "FATALITIES":
                    ...
                    break;
                case "WIND SPEED":
                    Value1QuestionLabel.Text = "Please enter the lower bound (integer) on the range of wind" +
                    ...
                    break;
                case "HAIL SIZE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (number in inches) on the range" +
                    ...
                    break;
                case "START RANGE":
                    Value1QuestionLabel.Text = "Please enter the lower bound of event start ranges" +
                    ...
                    break;
                case "END RANGE":
                    Value1QuestionLabel.Text = "Please enter the lower bound of event end ranges" +
                                               " (miles from nearest city as integer) you are searching for.";
                    Value2QuestionLabel.Text = "Please enter the upper bound of event end ranges" +
                                               " (miles from nearest city as integer) you are searching for.";
                    break;
                case "START YEAR":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as integer) on the range of" +
                                               " event start years you are searching for.";
                    Value2QuestionLabel.Text = "Please enter the upper bound (as integer) on the range of" +
                                               " event start years you are searching for.";
                    break;
                case "START MONTH":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as integer, 1-12) on the range of" +
                    ...
                    break;
                case "START DAY":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as integer, day of month) on the" +
                    ...
                    break;
                case "START TIME":
                    Value1QuestionLabel.Text = "Please enter the lower bound (24 hour time with no ':', EX" +
                ...
                case "END YEAR":
                    ...
                    break;
                case "END MONTH":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as integer, 1-12) on the range" +
                    ...
                    break;
                case "END DAY":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as integer, day of the month) on" +
                    ...
                    break;
                case "END TIME":
                    Value1QuestionLabel.Text = "Please enter the lower bound (24 hour time with no ':'," +
                    ...
                    break;
                case "TORNADO LENGTH":
                    Value1QuestionLabel.Text = "Please enter the lower bound (how far in miles) on the" +
                    ...
                    break;
                case "TORNADO WIDTH":
                    Value1QuestionLabel.Text = "Please enter the lower bound (yards) on the range of" +
                    ...
                    break;
                case "START LATITUDE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (-90 to 90) on the range of" +
                ...
                case "START LONGITUDE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (-180 to 180) on the range of" +
                    ...
                    break;
                case "END LATITUDE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (-90 to 90) on the range of event" +
                                               " end latitudes you are searching for.";
                    Value2QuestionLabel.Text = "Please enter the upper bound (-90 to 90) on the range of" +
                                               " event end latitudes you are searching for.";
                    break;
                case "END LONGITUDE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (-180 to 180) on the range" +
                                               " of event end longitudes you are searching for.";
                    Value2QuestionLabel.Text = "Please enter the upper bound (-180 to 180) on the range" +
                                               " of event end longitudes you are searching for.";
                    break;
                case "PROPERTY DAMAGE":
                    Value1QuestionLabel.Text = "Please enter the lower bound (as a number without '$')" +

...
&nbsp;
        ...
        <asp:UpdatePanel ID="ValueUpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <asp:RangeValidator ID="LowerStartRangeValidator" runat="server" ControlToValidate="LowerStartRangeTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <br />
                ...
                <asp:RangeValidator ID="LowerEndRangeValidator" runat="server" ControlToValidate="LowerEndRangeTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <br />
...
&nbsp;
                ...
                <asp:RangeValidator ID="LowerTornadoLengthRangeValidator" runat="server" ControlToValidate="LowerTornadoLengthTextBox" ErrorMessage="* Must be double &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <br />
                ...
                <asp:RangeValidator ID="LowerTornadoWidthRangeValidator" runat="server" ControlToValidate="LowerTornadoWidthTextBox" ErrorMessage="* Must be double &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <br />
                ...
                <asp:RangeValidator ID="LowerPropertyDamageRangeValidator" runat="server" ControlToValidate="LowerPropertyDamageTextBox" ErrorMessage="* Must be &gt;= 0 w/o commas" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="LowerCropDamageTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:RangeValidator ID="LowerCropDamageRangeValidator" runat="server" ControlToValidate="LowerCropDamageTextBox" ErrorMessage="* Must be &gt;= 0 w/o commas" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <br />
                <br />
                ...
                <asp:RangeValidator ID="UpperInjuriesRangeValidator" runat="server" ControlToValidate="UpperInjuriesTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperInjuriesCompareValidator" runat="server" ControlToCompare="LowerInjuriesTextBox" ControlToValidate="UpperInjuriesTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:RangeValidator ID="UpperFatalitiesRangeValidator" runat="server" ControlToValidate="UpperFatalitiesTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperFatalitiesCompareValidator" runat="server" ControlToCompare="LowerFatalitiesTextBox" ControlToValidate="UpperFatalitiesTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:RangeValidator ID="UpperWindSpeedRangeValidator" runat="server" ControlToValidate="UpperWindSpeedsTextBox" ErrorMessage="* Must be int &gt; =0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperWindSpeedCompareValidator" runat="server" ControlToCompare="LowerWindSpeedsTextBox" ControlToValidate="UpperWindSpeedsTextBox" ErrorMessage="*Upper bound must be &gt; lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:RangeValidator ID="UpperHailSizeRangeValidator" runat="server" ControlToValidate="UpperHailSizeTextBox" ErrorMessage="* Must be double &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperHailSizeCompareValidator0" runat="server" ControlToCompare="LowerHailSizeTextBox" ControlToValidate="UpperHailSizeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:RangeValidator ID="UpperStartRangeValidator" runat="server" ControlToValidate="UpperStartRangeTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperStartRangeCompareValidator" runat="server" ControlToCompare="LowerStartRangeTextBox" ControlToValidate="UpperStartRangeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:RangeValidator ID="UpperEndRangeValidator" runat="server" ControlToValidate="UpperEndRangeTextBox" ErrorMessage="* Must be int &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperEndRangeCompareValidator" runat="server" ControlToCompare="LowerEndRangeTextBox" ControlToValidate="UpperEndRangeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:CompareValidator ID="UpperStartYearCompareValidator" runat="server" ControlToCompare="LowerStartYearTextBox" ControlToValidate="UpperStartYearTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperStartMonthTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperStartMonthCompareValidator0" runat="server" ControlToCompare="LowerStartMonthTextBox" ControlToValidate="UpperStartMonthTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
                ...
                <asp:CompareValidator ID="UpperStartDayCompareValidator" runat="server" ControlToCompare="LowerStartDayTextBox" ControlToValidate="UpperStartDayTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperStartTimeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperStartTimeCompareValidator" runat="server" ControlToCompare="LowerStartTimeTextBox" ControlToValidate="UpperStartTimeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndYearTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndYearCompareValidator" runat="server" ControlToCompare="LowerEndYearTextBox" ControlToValidate="UpperEndYearTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual" Type="Integer"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndMonthTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndMonthCompareValidator" runat="server" ControlToCompare="LowerEndMonthTextBox" ControlToValidate="UpperEndMonthTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndDayTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndDayCompareValidator" runat="server" ControlToCompare="LowerEndDayTextBox" ControlToValidate="UpperEndDayTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndTimeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndTimeCompareValidator" runat="server" ControlToCompare="LowerEndTimeTextBox" ControlToValidate="UpperEndTimeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperTornadoLengthTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:RangeValidator ID="UpperTornadoLengthRangeValidator" runat="server" ControlToValidate="UpperTornadoLengthTextBox" ErrorMessage="* Must be double &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperTornadoLengthCompareValidator" runat="server" ControlToCompare="LowerTornadoLengthTextBox" ControlToValidate="UpperTornadoLengthTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperTornadoWidthTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:RangeValidator ID="UpperTornadoWidthRangeValidator" runat="server" ControlToValidate="UpperTornadoWidthTextBox" ErrorMessage="* Must be double &gt;= 0" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperTornadoWidthCompareValidator" runat="server" ControlToCompare="LowerTornadoWidthTextBox" ControlToValidate="UpperTornadoWidthTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperStartLatitudeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperStartLatitudeCompareValidator" runat="server" ControlToCompare="LowerStartLatitudeTextBox" ControlToValidate="UpperStartLatitudeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="LessThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperStartLongitudeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperStartLongitudeCompareValidator" runat="server" ControlToCompare="LowerStartLongitudeTextBox" ControlToValidate="UpperStartLongitudeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndLatitudeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndLatitudeCompareValidator" runat="server" ControlToCompare="LowerEndLatitudeTextBox" ControlToValidate="UpperEndLatitudeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual" Type="Integer"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperEndLongitudeTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:CompareValidator ID="UpperEndLongitudeCompareValidator" runat="server" ControlToCompare="LowerEndLongitudeTextBox" ControlToValidate="UpperEndLongitudeTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;&nbsp;<asp:TextBox ID="UpperPropertyDamageTextBox" runat="server" OnTextChanged="LowerStartRangeTextBox_TextChanged" Width="97px"></asp:TextBox>
                ...
                <asp:RangeValidator ID="UpperPropertyDamageRangeValidator" runat="server" ControlToValidate="UpperPropertyDamageTextBox" ErrorMessage="* Must be &gt;= 0 w/o commas" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperPropertyDamageCompareValidator" runat="server" ControlToCompare="LowerPropertyDamageTextBox" ControlToValidate="UpperPropertyDamageTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
                <br />
...
&nbsp;
                ...
                <asp:RangeValidator ID="UpperCropDamageRangeValidator0" runat="server" ControlToValidate="UpperCropDamageTextBox" ErrorMessage="* Must be &gt;= 0 w/o commas" ForeColor="Red" MaximumValue="1000000" MinimumValue="0" Type="Double"></asp:RangeValidator>
                <asp:CompareValidator ID="UpperCropDamageCompareValidator" runat="server" ControlToCompare="LowerCropDamageTextBox" ControlToValidate="UpperCropDamageTextBox" ErrorMessage="*Upper bound must be &gt;= lower bound" ForeColor="Red" Operator="GreaterThanEqual"></asp:CompareValidator>
            </ContentTemplate>
            <Triggers>
